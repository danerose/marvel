...
void main() {
  group('ComicDetail', () {
    test('two instances with the same properties should be equal', () {
      ...
      const comicDetail1 = ComicDetail(
        id: 1,
        title: 'Comic 1',
      ...
      const comicDetail2 = ComicDetail(
        id: 2,
        title: 'Comic 2',
      ...
      const comicDetail3 = ComicDetail(
        id: 1,
        title: 'Comic 1',
        description: 'Description 1',
        thumbnail: thumbnail1,
    ...
    test('fromJson() should return a valid ComicDetail instance', () {
      final json = {
        'id': 1,
        'title': 'Comic 1',
        'description': 'Description 1',
      ...
      final comicDetail = ComicDetail.fromJson(json);

      expect(comicDetail, isA<ComicDetail>());
