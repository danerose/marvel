...
void main() {
  group('EventDetail', () {
    test('two instances with the same properties should be equal', () {
      ...
      const comicDetail1 = EventDetail(
        id: 1,
        title: 'Comic 1',
      ...
      const comicDetail2 = EventDetail(
        id: 2,
        title: 'Comic 2',
      ...
      const comicDetail3 = EventDetail(
        id: 1,
        title: 'Comic 1',
        description: 'Description 1',
        thumbnail: thumbnail1,
    ...
    test('fromJson() should return a valid EventDetail instance', () {
      final json = {
        'id': 1,
        'title': 'Comic 1',
        'description': 'Description 1',
      ...
      final comicDetail = EventDetail.fromJson(json);

      expect(comicDetail, isA<EventDetail>());
